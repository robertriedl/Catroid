...
public interface Brick extends Serializable, Cloneable {
	...
	enum BrickField {
		...
		SHOWVARIABLE, SHOWVARIABLE_SIZE, SHOWVARIABLE_COLOR_RED, SHOWVARIABLE_COLOR_GREEN, SHOWVARIABLE_COLOR_BLUE,
		HIDEVARIABLE, STRING, ROTATION_STYLE, REPEAT_UNTIL_CONDITION, ASK_QUESTION, NFC_NDEF_MESSAGE, ASK_SPEECH_QUESTION,

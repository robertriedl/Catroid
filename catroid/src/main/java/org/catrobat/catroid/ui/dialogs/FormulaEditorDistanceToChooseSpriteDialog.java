...
public class FormulaEditorDistanceToChooseSpriteDialog extends FormulaEditorChooseSpriteDialog {

	private boolean distanceToTouchPositionSelected;

	public static FormulaEditorDistanceToChooseSpriteDialog newInstance() {
		return new FormulaEditorDistanceToChooseSpriteDialog();
	}
	...
	protected void setUpSpinner(View dialogView) {
		...
		spriteNames.add(getString(R.string.formula_editor_object_distance_to_touch_position_spinner_selection));
	...
	public boolean getDistanceToTouchPositionSelected() {
		if (spinnerOne.getSelectedItemId() == 0) {
